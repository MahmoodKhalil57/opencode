export const dict = {
  ...
  "settings.providers.connected.addAnother": "+ Add another",
  "provider.connect.alias.title": "Add another {{provider}} account",
  "provider.connect.alias.description": "Saves a new {{provider}} credential under a unique name. Your existing credential is preserved.",
  "provider.connect.alias.label": "Credential name",
  "provider.connect.alias.placeholder": "e.g. {{provider}}-2",
  "provider.connect.alias.continue": "Continue",
  "provider.connect.alias.required": "Name is required",
  "provider.connect.alias.differentRequired": "Pick a different name from the existing credential",
  "provider.connect.alias.alreadyExists": "A credential with this name already exists",
